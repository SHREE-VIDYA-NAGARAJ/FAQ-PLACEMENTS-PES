...
def initialize_rag_system():
    ...
    Settings.llm = Groq(
        ...
        context_window=8192,
        temperature=0.7,
        system_prompt="""You are a helpful assistant that provides information about campus placement procedures. 
        Always structure your responses as clear, concise points. Each point should be a complete thought.
        Be specific and avoid vague statements. If you're not sure about something, say so."""
    )
...
# Chat input
if prompt := st.chat_input("Ask about campus placement procedures..."):
